                ...
                <tr class="border-b hover:bg-[#1D2F41]">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex flex-col">
                            <span>
                                {!! $field->selection_line_a !!}
                            </span>
                            <span>
                                {!! $field->selection_line_b !!}
                            </span>
                        </div>
                    </td>
                        <td class="px-6 py-4">
                        <div class="flex flex-col">
                            <div class="flex flex-row items-center gap-2">
                                <span>{!! $field->best_odds_a !!}</span>
                                {!! $field->sportsbook_a !!}
                            </div>
                            <div class="flex flex-row items-center gap-2">
                                <span>{!! $field->best_odds_b !!}</span>
                                {!! $field->sportsbook_b !!}
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        @if($field->uid)
                        <button class="btn--view-modal" data-modal-target="viewModal" data-modal-toggle="viewModal" class="bg-transparent outline-none" type="button" data-bet_type="{!! $field->bet_type !!}" data-id="{!! $field->uid !!}">
