        ...
        <tbody class="text-white" id="arbitrage_body">
            ...
            @foreach($games ?? [] as $field)
                ...
                <tr class="border-b hover:bg-[#1D2F41]">
                    ...
                    <td class="px-6 py-4">
                        <span wire:loading class="placeholder-content">&nbsp;</span>
                        <span wire:loading.remove>{!! formatEvent($field) !!}</span>
                    </td>
                    <td class="px-6 py-4">
                        <span wire:loading class="placeholder-content">&nbsp;</span>
                    ...
                    <td class="px-6 py-4">
                        ...
                        <span wire:loading class="placeholder-content">&nbsp;</span>
                        <span wire:loading.remove>
                            <button class="btn--view-modal" data-modal-target="viewModal" data-modal-toggle="viewModal" class="outline-none text-white" type="button" data-bet_type="{!! $field->bet_type !!}" data-id="{!! $field->uid !!}">
