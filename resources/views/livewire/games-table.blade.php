    ...
    @forelse($games ?? [] as $field)
        <div class="relative bg-[#1D2F41] rounded text-white my-2">
                ...
                <div class="flex items-center justify-center pt-1">
                    ...
                    <span wire:loading class="placeholder-content">&nbsp;</span>
                    <span wire:loading.remove>
                        <p class="font-prompt text-xl">{!! $field->profit_percentage !!}%</p>
                ...
                <div class="border-b">
                    <div class="py-2 text-center">
                        ...
                        <span wire:loading class="placeholder-content">&nbsp;</span>
                        <span wire:loading.remove>
                                    <p class="text-sm font-semibold text-white">{!! $field->home_team !!}
                            <span class="text-xs text-brand-gray-7">vs</span> {!! $field->away_team !!}</p>
                        </span>
                ...
                <div class="border-b py-1">
                    <div class="text-center">
                        ...
                        <span wire:loading class="placeholder-content">&nbsp;</span>
                        <span wire:loading.remove>
                            <p class="text-sm text-brand-gray-7">{!! formatEventDate($field->start_date) !!}</p>
                        </span>
                    ...
                    <div class="text-center">
                        ...
                        <span wire:loading class="placeholder-content">&nbsp;</span>
                        <span wire:loading.remove>
                             <p class= "text-sm text-brand-gray-7">{!! ucfirst($field->sport) !!}, {!! ucfirst($field->league) !!}</p>
                            <div class="text-center">
                                <p class= "text-sm text-blue-500">{!! $field->bet_type !!}</p>
                            </div>
                        </span>
                ...
                <div class="grid grid-cols-2 border-b">
                    <div class="flex justify-center">
                        <span wire:loading class="placeholder-content">&nbsp;</span>
                        <span wire:loading.remove>
                            <p class= "text-xs font-medium text-gray-400">BET ODDS</p>
                            <p class= "text-sm font-bold text-white">{!! $field->best_odds_a !!}</p>
                        </span>
                    </div>
                    <div class="flex justify-center border-l">
                        <div class="py-1 text-center">
                            ...
                            <span wire:loading.remove>
                                <p class= "text-xs font-medium text-gray-400">BET ODDS</p>
                                <p class= "text-sm font-bold text-white">{!! $field->best_odds_b !!}</p>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="grid grid-cols-2 border-b">
                    <div class="flex flex-col justify-center px-1 py-1 text-sm text-white">
                        <div class="pb-1 text-center">
                            <span wire:loading class="placeholder-content">&nbsp;</span>
                            <span wire:loading.remove>
                                <p class= " text-sm text-white">{!! $field->selection_line_a !!}</p>
                            ...
                            <div class="grid grid-flow-col gap-1 overflow-auto">
                                <div role="button" tabindex="-1" class="cursor-default w-[25px] h-[25px]">
                                    <div class="overflow-hidden rounded" style="height: 25px; width: 25px;">
                                        <span wire:loading class="placeholder-content">&nbsp;</span>
                                        <span wire:loading.remove style="box-sizing: border-box; display: inline-block; overflow: hidden; width: 25px; height: 25px; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative;">
                    ...
                    <div class="flex flex-col justify-center border-l px-1 py-1">
                        <div class="pb-1 text-center">
                            <p class="text-sm text-white">{!! $field->selection_line_b !!}</p>
