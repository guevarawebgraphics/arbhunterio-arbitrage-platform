...
@section('content')
	<div class="container-fluid">
            <div class="block-header ">
                <div class="pull-left">
                    <h2>Edit Menu Dropdown: "{{ $dropdown->name }}"</h2>
                </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                EDIT MENU DROPDOWN FORM
                            </h2>
                        </div>
                        <div class="body">
                            {!! Form::model($dropdown, ['method' => 'PATCH','route' => ['admin.dropdown_menu.update', $dropdown->id]]) !!}
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <div class="form-line">
                                            {!! Form::select('menu_id', $menus, $menu, array('class' => 'form-control')) !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <div class="switch">
                                                <label>
                                                    <input type="checkbox" value="1" name="is_page" id="is_page" {{ Request::old('is_page') ? : ($dropdown->is_page ? 'checked' : '') }}><span class="lever switch-col-blue"></span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-line">
                                            <select class="form-control" name="order_number" id="order_number">
                                                ...
                                                @foreach ($ordering as $order)
                                                    @if($order == $dropdown->order_number)
...
<script> 
    ...
    window.is_page = '<?php echo $dropdown->is_page; ?>'; 
</script>
