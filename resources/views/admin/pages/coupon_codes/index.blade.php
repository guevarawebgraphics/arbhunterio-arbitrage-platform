	...
	<div class="container-fluid">
            <div class="block-header ">
                ...
                <div class="pull-right">
                    @can('Create Role')
                        <a class="btn btn-success" href="{{ route('admin.coupon_codes.create') }}"> Create New Coupon Code</a>
                    @endcan
                </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <table id="coupon_codes-table" class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Name</th>
...
{{Html::script('public/js/bjcdl/libraries/coupon_codes.js')}}
@endsection