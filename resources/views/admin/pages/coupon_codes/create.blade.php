            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            {!! Form::open(array('route' => 'admin.coupon_codes.store','method'=>'POST')) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <div class="input-daterange input-group" id="bs_datepicker_range_container">
                                                ...
                                                <div class="form-line">
                                                    <input type="text" name="date_end" class="form-control" placeholder="Date end...">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <div class="switch">
                                                <label>
                                                    <input type="checkbox" value="1" name="is_no_time_limit" checked><span class="lever switch-col-blue"></span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <div class="switch">
                                                <label>
                                                    <input type="checkbox" value="1" name="once_per_customer" checked><span class="lever switch-col-blue"></span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
