                            ...
                            {{-- <tr class="border-b hover:bg-[#1D2F41]">
                                <td class="w-4 p-4">
                                    <div class="flex items-center">
                                        <button data-modal-target="calculatorModal" data-modal-toggle="calculatorModal" class="bg-transparent outline-none" type="button">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex flex-col">
                                        ...
                                        <div class="flex flex-row items-center gap-2">
                                            <span>-109</span>
                                            <img class="rounded" width="24"  src="{{asset('public/assets/img/fliff.webp')}}" alt="">
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
