        ...
        <div class="card">
            ...
            <div class="row">
                ...
                <form method="post" action="{{ route('settings.update_profile') }}">
                    @csrf
                    <input type="hidden" name="view" value="bet-tracker-notifications">
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div class="p-3 text-right">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" class="sr-only peer" name="clv_notification_enabled" value="1" {{ auth()->user()->clv_notification_enabled == 1 ? 'checked' : '' }}>
                    ...
                    <div class="p-3">
                        ...
                        <input type="number" name="clv_notification_threshold" style="width: 100%;" value="{{ auth()->user()->clv_notification_threshold }}">
                    </div>
                    <br>
