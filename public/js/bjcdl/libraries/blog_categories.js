...
$.blog_categories.init = {
    activate: function () {
        ...
        var table = $('#blog_categories-table').DataTable({
            ajax: '',
            serverSide: true,
            processing: true,
            aaSorting:[[0,"desc"]],
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        method: "POST",
                        dataType: 'JSON',
                        url: sAdminBaseURI + '/blog_categories/' + rowid +'/delete',
                                    ...
                                    cancelButtonText: 'Ok'
                                        ...
                                        if (result.isConfirmed) {
                                            ...
                                            $.ajax({
                                                ...
                                                method: "GET",
                                                url: sAdminBaseURI + '/blog_categories/' + rowid +'/restore',
                                                success: function (data) {
                                                    $('#blog_categories-table').DataTable().ajax.reload();
                                                    Swal.fire(
                                                        'Restored!',
