...
$.gallery_groups.init = {
    activate: function () {
        ...
        var table = $('#gallery_groups-table').DataTable({
            ajax: '',
            serverSide: true,
            processing: true,
            aaSorting:[[0,"desc"]],
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        method: "POST",
                        dataType: 'JSON',
                        url: sAdminBaseURI + '/gallery_groups/' + rowid +'/delete',
                                    ...
                                    cancelButtonText: 'Ok'
                                        ...
                                        if (result.isConfirmed) {
                                            ...
                                            $.ajax({
                                                ...
                                                method: "GET",
                                                url: sAdminBaseURI + '/gallery_groups/' + rowid +'/restore',
                                                success: function (data) {
                                                    $('#gallery_groups-table').DataTable().ajax.reload();
                                                    Swal.fire(
                                                        'Restored!',
