...
$.system_settings.init = {
    activate: function () {
        ...
        var table = $('#system_settings-table').DataTable({
            ajax: '',
            serverSide: true,
            processing: true,
            aaSorting:[[0,"desc"]],
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        method: "POST",
                        dataType: 'JSON',
                        url: sAdminBaseURI + '/system_settings/' + rowid +'/delete',
                                    ...
                                    cancelButtonText: 'Ok'
                                        ...
                                        if (result.isConfirmed) {
                                            ...
                                            $.ajax({
                                                ...
                                                method: "GET",
                                                url: sAdminBaseURI + '/system_settings/' + rowid +'/restore',
                                                success: function (data) {
                                                    $('#system_settings-table').DataTable().ajax.reload();
                                                    Swal.fire(
                                                        'Restored!',
    ...
    edit: function () {
        ...
        $(function() {
            ...
            if (window.file != '') {
                ...
                $(".image-preview-filename").val(window.file); 
                img.attr('src', window.file);
...
$(function () {
    ...
    if (page == 'system_settings') {
        $.system_settings.init.activate();
    } else if (page == 'edit') {
        $.system_settings.init.edit();
    }
});