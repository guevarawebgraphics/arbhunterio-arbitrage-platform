                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            @can('Create DefaultTemplate')
                                <span class="padding-lefttitle">
                                    <a href="{{ route('admin.template_snake_case_plural.create') }}" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i> Add New DefaultTemplate</a>
                                </span>
                            @endcan
                        </div>
                    </div>
